...
const providers = [
  { key: "ors", credential: "ORS_API_KEY", create: (key: string) => new OpenRouteServiceProvider(key, http) },
  { key: "graphhopper", credential: "GRAPHHOPPER_API_KEY", create: (key: string) => new GraphHopperProvider(key, http) },
